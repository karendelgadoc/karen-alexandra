    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-start">
        <div className="aspect-[3/4] overflow-hidden bg-[var(--beige)] sticky top-28">
          <Image
            src="http://karenalexandra.com/wp-content/uploads/2025/06/IMG_4534.jpg"
            alt="Karen Alexandra"
            width={600}
            height={800}
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-3 gap-3">
          {[
            "http://karenalexandra.com/wp-content/uploads/2025/06/IMG_4585-edited.jpg",
            "http://karenalexandra.com/wp-content/uploads/2025/06/IMG_4593.jpg",
            "http://karenalexandra.com/wp-content/uploads/2025/06/IMG_6819.jpg",
          ].map((src, i) => (
